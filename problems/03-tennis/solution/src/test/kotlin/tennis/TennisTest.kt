...
class TennisTest {
    fun checkAllScoresTennisGame1() {
        checkAllScores(createGame = { TennisGame1("player1", "player2") })
    }

    fun checkAllScoresTennisGame2() {
        checkAllScores(createGame = { TennisGame2("player1", "player2") })
    }

    fun checkAllScoresTennisGame3() {
        checkAllScores(createGame = { TennisGame3("player1", "player2") })
    }

    fun checkAllScoresTennisGame4() {
        checkAllScores(createGame = { TennisGame4("player1", "player2") })
    }

    fun checkAllScoresTennisGame5() {
        checkAllScores(createGame = { TennisGame5("player1", "player2") })
    }

    fun checkAllScoresTennisGame6() {
        checkAllScores(createGame = { TennisGame6("player1", "player2") })
    }

    fun checkAllScoresTennisGame7() {
        checkAllScores(
            createGame = { TennisGame7("player1", "player2") },
    ...
    private fun allScores(): List<ScoreCase> =
        listOf(
            ...
            ScoreCase(4, 0, "Win for player1"),
            ScoreCase(0, 4, "Win for player2"),
            ScoreCase(2, 1, "Thirty-Fifteen"),
            ScoreCase(1, 2, "Fifteen-Thirty"),
            ScoreCase(3, 1, "Forty-Fifteen"),
            ScoreCase(1, 3, "Fifteen-Forty"),
            ScoreCase(4, 1, "Win for player1"),
            ScoreCase(1, 4, "Win for player2"),
            ScoreCase(3, 2, "Forty-Thirty"),
            ScoreCase(2, 3, "Thirty-Forty"),
            ScoreCase(4, 2, "Win for player1"),
            ScoreCase(2, 4, "Win for player2"),
            ScoreCase(4, 3, "Advantage player1"),
            ScoreCase(3, 4, "Advantage player2"),
            ScoreCase(5, 4, "Advantage player1"),
            ScoreCase(4, 5, "Advantage player2"),
            ScoreCase(15, 14, "Advantage player1"),
            ScoreCase(14, 15, "Advantage player2"),
            ScoreCase(6, 4, "Win for player1"),
            ScoreCase(4, 6, "Win for player2"),
            ScoreCase(16, 14, "Win for player1"),
            ScoreCase(14, 16, "Win for player2"),
        )
}
